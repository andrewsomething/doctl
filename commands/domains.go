...
func Domain() *Command {
	...
	cmdRunDomainDelete := CmdBuilderWithDocs(cmd, RunDomainDelete, "delete <domain>", "Delete a domain",`Use this command to delete a domain from your account. This is irreversible.`, Writer, aliasOpt("g"))
