...
A Floating IP Address must be either assigned to a Droplet or reserved to a region.`, Writer,
	...
	cmdRunFloatingIPDelete := CmdBuilderWithDocs(cmd, RunFloatingIPDelete, "delete <floating-ip>", "Permanently delete a Floating IP Address","Use this command to permanently delete a Floating IP address. This is irreversible.", Writer, aliasOpt("d"))
